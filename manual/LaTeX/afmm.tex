...
\lstdefinelanguage{AFMM} 
	{morekeywords={size,solve,wavelength, rectangle, substrate, draw, harmonics, pml,inpstruct, inpnf, outgmodes, lowindex, highindex, indfile, pml_transf, bend, wants,spectrum,propagation,assemble,section,order,excitation,quit,help,...
	load, print, select, coefficient, coefficient_id, carpet, outdata, matdev, norm, clear, system, goto, label, for, next, eigenvc, eigenam, memocc, symmetry,monitor, power, powerz, let, bloch, outbloch, if, else, endif, size, lg, ln, sin, cos, tan, sqr, abs,arctan,arcsin,arccos,sinh, cosh,tanh,fopen,fclose,
...
\begin{document}
\title{The \afmm\ 1.5 user manual\\[2em]
